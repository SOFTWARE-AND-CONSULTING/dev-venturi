...
import { SinOrdenComponent } from './sin-orden.component';
import { SinOrdenRoutes } from './sin-orden.routing';
...
@NgModule({
    ...
    imports: [
        RouterModule.forChild(SinOrdenRoutes),
        MatButtonModule,
        MatIconModule,
        SharedModule,
        MatMenuModule,
